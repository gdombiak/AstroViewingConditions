...
public struct CuratedDeepSkyCatalogProvider: DeepSkyCatalogProvider {
    ...
    private static let catalog: [DeepSkyCatalogEntry] = [
        ...
        entry("m30", "M30 Globular Cluster", "M30", .globularCluster, "Capricornus", 21.6728, -23.1799, 7.2, "12 arcmin", 11.0, 0.65, .smallTelescope, .standard, "Dense globular cluster with a bright core.", image: TargetImageManifest.image(for: "m30")),
        ...
        entry("m36", "M36 Pinwheel Cluster", "M36", .openCluster, "Auriga", 5.6017, 34.1400, 6.3, "12 arcmin", nil, 0.25, .binoculars, .easy, "Bright young open cluster that is easy to find with binoculars or a small telescope.", image: TargetImageManifest.image(for: "m36")),
        entry("m38", "M38 Starfish Cluster", "M38", .openCluster, "Auriga", 5.4783, 35.8333, 7.4, "21 arcmin", nil, 0.4, .binoculars, .standard, "Large open cluster whose brighter stars form a distinctive cross or starfish pattern.", image: TargetImageManifest.image(for: "m38")),
        ...
        entry("ngc7293", "NGC 7293 Helix Nebula", "NGC 7293", .planetaryNebula, "Aquarius", 22.4933, -20.8372, 7.6, "25 x 20 arcmin", 13.6, 0.8, .telescope, .challenge, "Very large planetary nebula with low surface brightness.", image: TargetImageManifest.image(for: "ngc7293")),
        entry("m51", "M51 Whirlpool Galaxy", "M51", .galaxy, "Canes Venatici", 13.4978, 47.1952, 8.4, "11 x 7 arcmin", 12.9, 0.75, .telescope, .challenge, "Face-on galaxy whose spiral detail needs dark skies.", image: TargetImageManifest.image(for: "m51")),
        entry("m64", "M64 Black Eye Galaxy", "M64", .galaxy, "Coma Berenices", 12.9455, 21.6827, 8.5, "10 x 5 arcmin", 12.8, 0.7, .telescope, .challenge, "Galaxy with a prominent dark dust feature.", image: TargetImageManifest.image(for: "m64")),
        entry("m77", "M77 Cetus A", "M77", .galaxy, "Cetus", 2.7113, -0.0133, 9.6, "7.1 x 6.0 arcmin", 13.0, 0.8, .telescope, .challenge, "Galaxy with a bright compact core; dark skies are needed to see more than its central region.", image: TargetImageManifest.image(for: "m77")),
        entry("m81", "M81 Bode's Galaxy", "M81", .galaxy, "Ursa Major", 9.9259, 69.0653, 6.9, "27 x 14 arcmin", 13.0, 0.55, .binoculars, .standard, "Bright galaxy, though extended detail favors dark skies.", image: TargetImageManifest.image(for: "m81")),
        entry("m82", "M82 Cigar Galaxy", "M82", .galaxy, "Ursa Major", 9.9313, 69.6797, 8.4, "11 x 5 arcmin", 12.7, 0.6, .smallTelescope, .standard, "High-surface-brightness edge-on galaxy.", image: TargetImageManifest.image(for: "m82")),
        ...
        entry("double-cluster", "NGC 869/884 Double Cluster", "NGC 869/884", .openCluster, "Perseus", 2.3333, 57.1333, 3.7, "60 arcmin", nil, 0.2, .binoculars, .easy, "A rewarding pair of clusters for binoculars or low-power telescopes.", image: TargetImageManifest.image(for: "double-cluster"), displayTypeNameOverride: "Open Cluster Pair"),
