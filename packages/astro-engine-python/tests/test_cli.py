...
TRAILING_FIXTURES: tuple[tuple[str, str, str], ...] = (
    ...
    (
        ...
        "after-midnight-previous-active-v1",
    ),
    (
...
def _assert_cli_success(capability: str, fixture: dict) -> dict:
    ...
    assert envelope["engine_semver"] == "1.1.0"
...
def test_engine_version() -> None:
    ...
    assert payload == {"engine_semver": "1.1.0"}
...
def test_unknown_capability_is_usage() -> None:
    ...
    assert "Public capability allow-list:" in stderr
